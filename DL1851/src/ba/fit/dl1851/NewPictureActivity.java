...
public class NewPictureActivity extends Activity {
    ...
    private static String url_create_picture = "http://127.0.0.1/android_connect/create_picture.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Edit Text
        inputName = (EditText) findViewById(R.id.inputNaziv);
    ...
    class CreateNewProduct extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jsonParser.makeHttpRequest(url_create_picture,
                    "POST", params);
